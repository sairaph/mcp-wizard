...
// FirstSelectable returns the index of the first selectable harness, or -1.
...
// MoveCursor moves the cursor dir rows through the visible harnesses,
...
// ToggleHarness flips the selection of the harness under the cursor.
...
// ToggleAll selects every selectable harness, or clears the selection when
