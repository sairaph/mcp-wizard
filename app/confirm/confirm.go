// Package confirm provides a two-option confirmation prompt.
package confirm
...
// Model is the confirm prompt state.
type Model struct {
	Title   string
	Detail  string
	Confirm string
...
// New creates a prompt with the given title, detail and option labels.
